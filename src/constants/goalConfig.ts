...
export const PRIMARY_GOALS: PrimaryGoalDef[] = [
  ...
  { id: 'improve_flexibility', label: 'Improve Flexibility',        category: 'health_longevity', description: 'Dedicated stretching routines to increase muscle length. Includes static, dynamic, and PNF stretching methods.',  launch: false },
