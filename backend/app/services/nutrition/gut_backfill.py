...
from app.models import MealItem, Meal, FoodMetadata, DailyNutritionMetrics
from app.services.nutrition.ai_classify import get_or_create_metadata
from app.services.nutrition.food_classifier import CLASSIFIER_VERSION
...
def run_full_backfill(*, allow_ai: bool = False) -> dict:
    ...
    return {"metadata": meta_stats, "daily": daily_stats}
