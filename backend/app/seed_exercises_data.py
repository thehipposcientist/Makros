...
MOBILITY = [
    ...
    # These are mobility exercises, NOT strength. They appear on
    # Mobility Flow / Recovery / Stretch Block days in the planner,
    # never on lifting days. The active workout screen uses the timer
    # mode automatically because exercise_type = "mobility".
    {
        "slug": "yoga_flow",
        "name": "Yoga Flow",
        "primary_muscle": "full_body",
        ...
        "is_unilateral": False,
        "difficulty": "beginner",
        "description": "Timed yoga session — sun salutations, warrior poses, and hip openers. Set your duration and flow.",
        "equipment": [],
        "default_reps": "10-20 min",
    },
    {
        "slug": "yoga_sun_salutation",
        ...
        "is_unilateral": False,
        "difficulty": "beginner",
        "description": "Mountain pose → forward fold → plank → cobra → downward dog. One cycle = one rep.",
        "equipment": [],
    },
    {
        "slug": "yoga_warrior_series",
        "name": "Warrior Series (I, II, III)",
        "primary_muscle": "quads",
        ...
        "is_unilateral": True,
        "difficulty": "beginner",
        "description": "Hold each warrior pose 30-60s per side. Balance, hip mobility, and leg endurance.",
        "equipment": [],
        "default_reps": "30-60s each",
    },
    {
        "slug": "yoga_pigeon_pose",
        "name": "Pigeon Pose",
        "primary_muscle": "glutes",
        "secondary_muscles": ["hamstrings"],
        "equipment_bucket": "bodyweight",
        ...
        "is_unilateral": True,
        "difficulty": "beginner",
        "description": "Deep hip opener — 60-90s per side. Best stretch for tight glutes and hip flexors.",
        "equipment": [],
        "default_reps": "60-90s each",
    },
    {
        "slug": "yoga_downward_dog",
        "name": "Downward Dog",
        "primary_muscle": "hamstrings",
        "secondary_muscles": ["shoulders", "calves", "core"],
        "equipment_bucket": "bodyweight",
        "movement_pattern": "mobility",
        "exercise_type": "mobility",
        "power_type": "mobility",
        ...
        "is_unilateral": False,
        "difficulty": "beginner",
        "description": "Hold 30-60s or pedal feet. Stretches hamstrings, calves, and shoulders.",
        "equipment": [],
        "default_reps": "30-60s",
    },
]
