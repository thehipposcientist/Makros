...
from app.routers import auth, profile, workouts, meals, meta, ai, coach, saved_meals, supplements, sleep, health as health_router, readiness as readiness_router, recovery as recovery_router, social, plan_weeks
